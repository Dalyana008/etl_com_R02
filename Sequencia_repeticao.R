...
# repetições
classeSimulacao <- c(rep("Crianca", length(distBinominalSimulacao)/3), rep("Crianca Grande", length(distBinominalSimulacao)/3)) 
# vetor repetindo a classe Jovem 15x e Jovem Adulto 15x
