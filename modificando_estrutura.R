# etl na prática: modifcando algumas informações
...
write.csv2(sinistrosRecifeRaw, "bases/sinistrosRecife.csv")
...
# exporta em formato nativo do R
saveRDS(sinistrosRecifeRaw, "etl_comR02/sinistrosRecife.rds")
